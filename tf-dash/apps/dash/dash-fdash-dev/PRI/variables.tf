...
variable "autoscaling_group_pri" { type = string }
...
variable "container_name_extract_pri" {
  type    = string
  default = "fdash-extract-pri"
}
variable "container_name_event_pri" {
  type    = string
  default = "fdash-event-pri"
}
variable "container_name_field_pri" {
  type    = string
  default = "fdash-field-pri"
}
variable "container_name_classify_pri" {
  type    = string
  default = "fdash-classify-pri"
}
variable "container_name_api_pri" {
  type    = string
  default = "fdash-api-pri"
}
variable "container_name_comparison_pri" {
  type    = string
  default = "fdash-comparison-pri"
}
variable "container_name_integration_pri" {
  type    = string
  default = "fdash-integration-pri"
}
variable "container_name_wrapper_pri" {
  type    = string
  default = "fdash-wrapper-pri"
}
variable "container_name_stitching_pri" {
  type    = string
  default = "fdash-stitching-pri"
}

variable "java_secret_pri" {
  type        = string
