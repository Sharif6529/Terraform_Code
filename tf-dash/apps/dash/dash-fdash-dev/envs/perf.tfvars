...
container_image   = "996190702173.dkr.ecr.us-east-1.amazonaws.com/fdash-extraction-service-perf"
container_image1  = "996190702173.dkr.ecr.us-east-1.amazonaws.com/fdash-dash-ui-perf"
container_image2  = "996190702173.dkr.ecr.us-east-1.amazonaws.com/fdash-api-service-perf"
container_image3  = "996190702173.dkr.ecr.us-east-1.amazonaws.com/fdash-classification-service-perf"
container_image4  = "996190702173.dkr.ecr.us-east-1.amazonaws.com/fdash-event-processing-service-perf"
container_image5  = "996190702173.dkr.ecr.us-east-1.amazonaws.com/fdash-auth-service-perf"
container_image6  = "996190702173.dkr.ecr.us-east-1.amazonaws.com/fdash-field-extraction-service-perf"
container_image7  = "996190702173.dkr.ecr.us-east-1.amazonaws.com/fdash-audit-log-service-perf"
container_image8  = "996190702173.dkr.ecr.us-east-1.amazonaws.com/fdash-comparison-service-perf"
container_image9  = "996190702173.dkr.ecr.us-east-1.amazonaws.com/fdash-integration-service-perf"
container_image10 = "996190702173.dkr.ecr.us-east-1.amazonaws.com/fdash-wrapper-service-perf"
container_image11 = "996190702173.dkr.ecr.us-east-1.amazonaws.com/fdash-stitching-service-perf"
...
log_groups = [
  "ecs-api-perf", "ecs-event-perf", "ecs-classify-perf", "ecs-auth-perf", "ecs-ui-perf", "ecs-extract-perf",
  "ecs-field-perf", "ecs-audit-perf", "ecs-comparison-perf", "ecs-integration-perf", "ecs-wrapper-perf", "ecs-stitching-perf"
]

log_groups_pri = [
  "ecs-event-perf-pri", "ecs-classify-perf-pri", "ecs-extract-perf-pri", "ecs-field-perf-pri",
  "ecs-api-perf-pri", "ecs-comparison-perf-pri", "ecs-integration-perf-pri", "ecs-wrapper-perf-pri", "ecs-stitching-perf-pri"
]

log_groups_msr = [
  "ecs-event-perf-msr", "ecs-classify-perf-msr", "ecs-extract-perf-msr", "ecs-field-perf-msr",
  "ecs-api-perf-msr", "ecs-comparison-perf-msr", "ecs-integration-perf-msr", "ecs-wrapper-perf-msr", "ecs-stitching-perf-msr"
]
...
sqs_names                         = ["fdash-page-classification-req-perf", "fdash-page-field-extraction-req-perf"]
log_configuration_api_new         = "/ecs-api-perf"
log_configuration_events_new      = "/ecs-event-perf"
log_configuration_classify_new    = "/ecs-classify-perf"
log_configuration_ui_new          = "/ecs-ui-perf"
log_configuration_auth_new        = "/ecs-auth-perf"
log_configuration_field_new       = "/ecs-field-perf"
log_configuration_audit_new       = "/ecs-audit-perf"
log_configuration_comparison_new  = "/ecs-comparison-perf"
log_configuration_integration_new = "/ecs-integration-perf"
log_configuration_wrapper_new     = "/ecs-wrapper-perf"
log_configuration_stitching_new   = "/ecs-stitching-perf"
log_configuration_extract_new     = "/ecs-extract-perf"

# Env Variable 

java_secret     = "-Dfreedom.app.name=fdash -Dfreedom.environment=perf -Dspring.profiles.active=perf -Dcloud.aws.region.static=us-east-1 -Dcloud.aws.region.auto=false"
java_secret_msr = "-Dfreedom.app.name=fdash -Dfreedom.environment=perf -Dspring.profiles.active=perf -Dfdash.infra.overridde=-msr -Dcloud.aws.region.static=us-east-1 -Dcloud.aws.region.auto=false"
java_secret_pri = "-Dfreedom.app.name=fdash -Dfreedom.environment=perf -Dspring.profiles.active=perf -Dfdash.infra.overridde=-pri -Dcloud.aws.region.static=us-east-1 -Dcloud.aws.region.auto=false"
